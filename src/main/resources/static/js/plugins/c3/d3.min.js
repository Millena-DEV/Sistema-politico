...
!function(t, n) {
    ...
    function c(t, n) {
        ...
        if (null == n)
            ...
            for (; ++a < i; )
                isNaN(e = u(n(t[a], a, t))) || (f += (r = e - c) * (e - (c += r / ++o)));
        if (o > 1)
            return f / (o - 1)
    }
    function f(t, n) {
    ...
    function m(t, n, e) {
        ...
        if (a > 0)
            for (t = Math.ceil(t / a),
            n = Math.floor(n / a),
            o = new Array(i = Math.ceil(n - t + 1)); ++u < i; )
                o[u] = (t + u) * a;
        else
            for (t = Math.floor(t * a),
            n = Math.ceil(n * a),
            o = new Array(i = Math.ceil(t - n + 1)); ++u < i; )
                o[u] = (t - u) / a;
        return r && o.reverse(),
        o
    }
    ...
    function w(t, n, e) {
        var r = Math.abs(n - t) / Math.max(0, e)
          ...
          , o = r / i;
        return o >= y ? i *= 10 : o >= _ ? i *= 5 : o >= b && (i *= 2),
        n < t ? -i : i
    }
    function M(t) {
    ...
    function B(t, n) {
        ...
        function l(l) {
            ...
            A = A.merge(M.append("text").attr("fill", "currentColor").attr(f, c * p).attr("dy", t === z ? "0em" : t === q ? "0.71em" : "0.32em")),
            l !== b && (m = m.transition(l),
            x = x.transition(l),
            N = N.transition(l),
            A = A.transition(l),
            w = w.transition(l).attr("opacity", L).attr("transform", function(t) {
            ...
            N.attr(f + "2", c * o),
            A.attr(f, c * p).text(d),
            b.filter(Y).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === R ? "start" : t === D ? "end" : "middle"),
            b.each(function() {
                this.__axis = _
            })
        }
        ...
        ,
        l.ticks = function() {
            return e = C.call(arguments),
            l
        }
        ,
        l.tickArguments = function(t) {
            return arguments.length ? (e = null == t ? [] : C.call(t),
            l) : e.slice()
        }
        ,
        l.tickValues = function(t) {
            return arguments.length ? (r = null == t ? null : C.call(t),
            l) : r && r.slice()
        }
        ,
    ...
    H.prototype = I.prototype = {
        ...
        on: function(t, n) {
            ...
            for (; ++a < u; )
                if ((e = (t = o[a]).type) && (e = j(i[e], t.name)))
                    return e
        },
        copy: function() {
            var t = {}
    ...
    function ot(t, n, e, r, i, o, a) {
        ...
        for (u = 0; u < l; ++u)
            (c = n[u]) && (d[u] = f = rt + a.call(c, c.__data__, u, n),
            f in s ? i[u] = c : s[f] = c);
        for (u = 0; u < h; ++u)
            (c = s[f = rt + a.call(t, o[u], u, o)]) ? (r[u] = c,
            c.__data__ = o[u],
            s[f] = null) : e[u] = new et(t,o[u]);
        for (u = 0; u < l; ++u)
            (c = n[u]) && s[d[u]] === c && (i[u] = c)
    }
    function at(t, n) {
    ...
    function lt(t) {
        this._node = t,
        this._names = ft(t.getAttribute("class") || "")
    }
    function ht(t, n) {
        for (var e = st(t), r = -1, i = n.length; ++r < i; )
            e.add(n[r])
    }
    function dt(t, n) {
        for (var e = st(t), r = -1, i = n.length; ++r < i; )
    ...
    var wt = {};
    (t.event = null,
    "undefined" != typeof document) && ("onmouseenter"in document.documentElement || (wt = {
    ...
    function It(t) {
        ...
        "onselectstart"in n ? e.on("selectstart.drag", Ft, !0) : (n.__noselect = n.style.MozUserSelect,
        n.style.MozUserSelect = "none")
    }
    function Ht(t, n) {
        var e = t.document.documentElement
          , r = zt(t).on("dragstart.drag", null);
        n && (r.on("click.drag", Ft, !0),
        setTimeout(function() {
    ...
    function vn(t) {
        return t instanceof Jt || (t = hn(t)),
        t ? new yn((t = t.rgb()).r,t.g,t.b,t.opacity) : new yn
    }
    function gn(t, n, e, r) {
    ...
    Zt(yn, gn, Qt(Jt, {
        brighter: function(t) {
            ...
            new yn(this.r * t,this.g * t,this.b * t,this.opacity)
        },
        darker: function(t) {
    ...
    function zn(t) {
        if (t instanceof qn)
            return new qn(t.l,t.a,t.b,t.opacity);
        if (t instanceof Fn) {
            if (isNaN(t.h))
                return new qn(t.l,0,0,t.opacity);
            var n = t.h * Mn;
            return new qn(t.l,Math.cos(n) * t.c,Math.sin(n) * t.c,t.opacity)
        }
        t instanceof yn || (t = vn(t));
        var e, r, i = On(t.r), o = On(t.g), a = On(t.b), u = Dn((.2225045 * i + .7168786 * o + .0606169 * a) / Sn);
        return i === o && o === a ? e = r = u : (e = Dn((.4360747 * i + .3850649 * o + .1430804 * a) / An),
        r = Dn((.0139322 * i + .0971045 * o + .7141733 * a) / kn)),
        new qn(116 * u - 16,500 * (e - u),200 * (u - r),t.opacity)
    }
    function Rn(t, n, e, r) {
    ...
    function Yn(t) {
        if (t instanceof Fn)
            return new Fn(t.h,t.c,t.l,t.opacity);
        if (t instanceof qn || (t = zn(t)),
        0 === t.a && 0 === t.b)
            return new Fn(NaN,0,t.l,t.opacity);
    ...
    Zt(qn, Rn, Qt(Jt, {
        ...
        rgb: function() {
            ...
            return new yn(Un(3.1338561 * (n = An * Ln(n)) - 1.6168667 * (t = Sn * Ln(t)) - .4906146 * (e = kn * Ln(e))),Un(-.9787684 * n + 1.9161415 * t + .033454 * e),Un(.0719453 * n - .2289914 * t + 1.4052427 * e),this.opacity)
        }
    })),
    Zt(Fn, Bn, Qt(Jt, {
        brighter: function(t) {
    ...
    function ye(t, n) {
        var e, r = typeof n;
        return null == n || "boolean" === r ? ne(n) : ("number" === r ? he : "string" === r ? (e = hn(n)) ? (n = e,
        ae) : ge : n instanceof hn ? ae : n instanceof Date ? le : Array.isArray(n) ? se : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? de : he)(t, n)
    }
    function _e(t, n) {
        return n -= t = +t,
        function(e) {
    ...
    var be, me, xe, we, Me = 180 / Math.PI, Ne = {
        translateX: 0,
        translateY: 0,
        rotate: 0,
        skewX: 0,
    ...
    var ke = Se(function(t) {
        return "none" === t ? Ne : (be || (be = document.createElement("DIV"),
        me = document.documentElement,
        xe = document.defaultView),
      ...
      , Te = Se(function(t) {
        return null == t ? Ne : (we || (we = document.createElementNS("http://www.w3.org/2000/svg", "g")),
    ...
    function qe(t, n) {
        ...
        if (h < ze)
            ...
            r = (y - g) / Ee,
            e = function(t) {
                var n, e = t * r, u = Re(g), c = a / (Ce * d) * (u * (n = Ee * e + g,
                ((n = Math.exp(2 * n)) - 1) / (n + 1)) - function(t) {
                    return ((t = Math.exp(t)) - 1 / t) / 2
                }(g));
    ...
    var Ie = Fe(re)
      , He = Fe(oe);
    var je, Xe, Ge = 0, Ve = 0, $e = 0, We = 1e3, Ze = 0, Qe = 0, Je = 0, Ke = "object" == typeof performance && performance.now ? performance : Date, tr = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
        setTimeout(t, 17)
    }
    ;
    function nr() {
    ...
    function or() {
        ...
        ++Ge;
        for (var t, n = je; n; )
            (t = Qe - n._time) >= 0 && n._call.call(null, t),
            n = n._next;
        --Ge
    }
    function ar() {
    ...
    function cr(t) {
        Ge || (Ve && (Ve = clearTimeout(Ve)),
        t - Qe > 24 ? (t < 1 / 0 && (Ve = setTimeout(ar, t - Ke.now() - Je)),
        $e && ($e = clearInterval($e))) : ($e || (Ze = Ke.now(),
        $e = setInterval(ur, We)),
        Ge = 1,
        tr(ar)))
    }
    ...
    rr.prototype = ir.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            this._next || Xe === this || (Xe ? Xe._next = this : je = this,
            Xe = this),
            this._call = t,
            this._time = e,
            cr()
    ...
    function br(t, n, e, r, i, o) {
        ...
        !function(t, n, e) {
            ...
            function a(n) {
                for (var i = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(u),
                e.state = yr,
                1), o = -1, a = r.length; ++o < a; )
                    r[o].call(t, i);
                e.state === yr && (e.on.call("end", t, t.__data__, e.index, e.group),
                u())
            }
            function u() {
                for (var r in e.state = _r,
                e.timer.stop(),
                delete i[n],
                i)
                    return;
    ...
    function Mr(t, n) {
        ...
        if (o) {
            ...
            o)
                (e = o[i]).name === n ? (r = e.state > pr && e.state < yr,
                e.state = _r,
                e.timer.stop(),
    ...
    function Ar(t, n) {
        var e;
        return ("number" == typeof n ? he : n instanceof hn ? ae : (e = hn(n)) ? (n = e,
        ae) : ge)(t, n)
    }
    ...
    function Pi(n) {
        var e, r = Ti, i = ki, o = I(u, "start", "brush", "end"), a = 6;
        function u(t) {
            ...
            t.selectAll(".selection").data([Si("selection")]).enter().append("rect").attr("class", "selection").attr("cursor", xi.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");
        ...
        function l() {
            ...
            if (i.apply(this, arguments)) {
                var r, o, a, u, s, l, h, d, p, v, g, y, _, b = this, m = t.event.target.__data__.type, x = "selection" === (t.event.metaKey ? m = "overlay" : m) ? pi : t.event.altKey ? yi : gi, w = n === bi ? null : Ni[m], M = n === _i ? null : Ai[m], N = Ei(b), A = N.extent, S = N.selection, k = A[0][0], T = A[0][1], E = A[1][0], C = A[1][1], P = w && M && t.event.shiftKey, z = Ot(b), R = z, q = f(b, arguments).beforestart();
                "overlay" === m ? N.selection = S = [[r = n === bi ? k : z[0], a = n === _i ? T : z[1]], [s = n === bi ? E : r, h = n === _i ? C : a]] : (r = S[0][0],
                a = S[0][1],
                s = S[1][0],
                h = S[1][1]),
                o = r,
                ...
                if (t.event.touches)
                    D.on("touchmove.brush", O, !0).on("touchend.brush touchcancel.brush", B, !0);
                else {
                    var U = zt(t.event.view).on("keydown.brush", function() {
                        ...
                        case 16:
                            ...
                            break;
                        case 18:
                            x === yi && (w < 0 ? s = l : w > 0 && (r = o),
                            M < 0 ? h = d : M > 0 && (a = u),
                            x = gi,
                            Y());
                            break;
                        case 32:
                            x === vi && (t.event.altKey ? (w && (s = l - p * w,
                            r = o + p * w),
                            M && (h = d - v * M,
                            a = u + v * M),
                            x = yi) : (w < 0 ? s = l : w > 0 && (r = o),
            ...
            function Y() {
                ...
                case vi:
                case pi:
                    w && (p = Math.max(k - r, Math.min(E - s, p)),
                    o = r + p,
                    l = s + p),
                    M && (v = Math.max(T - a, Math.min(C - h, v)),
                    u = a + v,
                    d = h + v);
                    break;
                case gi:
                    w < 0 ? (p = Math.max(k - r, Math.min(E - r, p)),
                    o = r + p,
                    l = s) : w > 0 && (p = Math.max(k - s, Math.min(E - s, p)),
                    o = r,
                    l = s + p),
                    M < 0 ? (v = Math.max(T - a, Math.min(C - a, v)),
                    u = a + v,
                    d = h) : M > 0 && (v = Math.max(T - h, Math.min(C - h, v)),
                    u = a,
                    d = h + v);
                    break;
                case yi:
                    w && (o = Math.max(k, Math.min(E, r - p * w)),
                    l = Math.max(k, Math.min(E, s + p * w))),
                    M && (u = Math.max(T, Math.min(C, a - v * M)),
                    d = Math.max(T, Math.min(C, h + v * M)))
                }
                l < o && (w *= -1,
                t = r,
                r = s,
                ...
                _ && (u = S[0][1],
                d = S[1][1]),
                S[0][0] === o && S[0][1] === u && S[1][0] === l && S[1][1] === d || (N.selection = [[o, u], [l, d]],
                c.call(b),
                q.brush())
            }
            function B() {
        ...
        u.extent = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : si([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            u) : r
        }
        ,
        u.filter = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : si(!!t),
            u) : i
        }
        ,
    ...
    Hi.prototype = ji.prototype = {
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            e && (l < 0 && (l = l % Fi + Fi),
            l > Ii ? this._ += "A" + e + "," + e + ",0,1," + s + "," + (t - a) + "," + (n - u) + "A" + e + "," + e + ",0,1," + s + "," + (this._x1 = c) + "," + (this._y1 = f) : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(l >= Bi) + "," + s + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
        },
    ...
    function po() {
        ...
        i.thresholds = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Array.isArray(t) ? uo(oo.call(t)) : uo(t),
            i) : e
        }
        ,
        i.smooth = function(t) {
            return arguments.length ? (r = t ? u : lo,
            i) : r === u
        }
        ,
        i
    ...
    function So(t) {
        ...
        function r(t, n) {
            ...
            function s() {
                ...
                if (t.charCodeAt(i) === wo) {
                    for (; a++ < o && t.charCodeAt(a) !== wo || t.charCodeAt(++a) === wo; )
                        ;
                    return (n = a) >= o ? c = !0 : (r = t.charCodeAt(a++)) === Mo ? f = !0 : r === No && (f = !0,
                    t.charCodeAt(a) === Mo && ++a),
                    t.slice(i + 1, n - 1).replace(/""/g, '"')
                }
                for (; a < o; ) {
                    if ((r = t.charCodeAt(n = a++)) === Mo)
                        f = !0;
                    else if (r === No)
                        f = !0,
                        t.charCodeAt(a) === Mo && ++a;
            ...
            for (t.charCodeAt(o - 1) === Mo && --o,
            t.charCodeAt(o - 1) === No && --o; (r = s()) !== xo; ) {
                for (var l = []; r !== mo && r !== xo; )
                    l.push(r),
                    r = s();
        ...
        return {
            ...
            format: function(n, e) {
                ...
                [e.map(o).join(t)].concat(n.map(function(n) {
    ...
    ia.copy = function() {
        var t, n, e = new ea(this._x,this._y,this._x0,this._y0,this._x1,this._y1), r = this._root;
        if (!r)
            return e;
        if (!r.length)
            return e._root = ra(r),
    ...
    ia.visit = function(t) {
        ...
        for (c && u.push(new Jo(c,this._x0,this._y0,this._x1,this._y1)); n = u.pop(); )
            if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
                var f = (r + o) / 2
                  , s = (i + a) / 2;
                (e = c[3]) && u.push(new Jo(e,f,s,o,a)),
                (e = c[2]) && u.push(new Jo(e,r,s,f,a)),
                (e = c[1]) && u.push(new Jo(e,f,i,o,s)),
                (e = c[0]) && u.push(new Jo(e,r,i,f,s))
            }
        return this
    }
    ,
    ia.visitAfter = function(t) {
        ...
        for (this._root && e.push(new Jo(this._root,this._x0,this._y0,this._x1,this._y1)); n = e.pop(); ) {
            ...
            if (i.length) {
                ...
                (o = i[0]) && e.push(new Jo(o,a,u,s,l)),
                (o = i[1]) && e.push(new Jo(o,s,u,c,l)),
                (o = i[2]) && e.push(new Jo(o,a,l,s,f)),
                (o = i[3]) && e.push(new Jo(o,s,l,c,f))
            }
            r.push(n)
        }
        for (; n = r.pop(); )
    ...
    var wa, Ma = ["y", "z", "a", "f", "p", "n", "Âµ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    function Na(t) {
        var n, e, r = t.grouping && t.thousands ? (n = t.grouping,
        e = t.thousands,
        function(t, r) {
        ...
        ) : xa, i = t.currency, o = t.decimal, a = t.numerals ? function(t) {
            return function(n) {
                return n.replace(/[0-9]/g, function(n) {
                    return t[+n]
                })
            }
        }(t.numerals) : xa, u = t.percent || "%";
        function c(t) {
            var n = (t = ya(t)).fill
              , e = t.align
              , c = t.sign
            ...
            function m(t) {
                ...
                switch (h && s && (t = r(N + t, N.length ? l - x.length : 1 / 0),
                N = ""),
                e) {
                case "<":
                    t = m + t + x + N;
    ...
    function Aa(n) {
        return wa = Na(n),
        t.format = wa.format,
        t.formatPrefix = wa.formatPrefix,
        wa
    }
    function Sa(t) {
    ...
    Ca.prototype = {
        ...
        add: function(t) {
            za(Pa, t, this.t),
            za(this, Pa.s, this.s),
            this.s ? this.t += Pa.t : this.s = Pa.t
        },
        valueOf: function() {
            return this.s
        }
    ...
    var fu, su, lu, hu, du, pu = Ea(), vu = Ea(), gu = {
        point: eu,
        lineStart: eu,
        lineEnd: eu,
        ...
        polygonEnd: function() {
            var t = +pu;
            vu.add(t < 0 ? Oa + t : t),
            this.lineStart = this.lineEnd = this.point = eu
        },
        sphere: function() {
            vu.add(Oa)
        }
    ...
    var Tu, Eu, Cu, Pu, zu, Ru, qu, Du, Lu, Uu, Ou, Yu, Bu, Fu, Iu, Hu, ju, Xu, Gu, Vu, $u, Wu, Zu, Qu, Ju, Ku, tc = Ea(), nc = {
        point: ec,
        lineStart: ic,
        lineEnd: oc,
        polygonStart: function() {
        ...
        polygonEnd: function() {
            ...
            nc.lineEnd = oc,
            pu < 0 ? (Tu = -(Cu = 180),
            Eu = -(Pu = 90)) : tc > Ra ? Pu = 90 : tc < -Ra && (Eu = -90),
            Uu[0] = Tu,
            Uu[1] = Cu
        }
    };
    function ec(t, n) {
        Lu.push(Uu = [Tu = t, Cu = t]),
        n < Eu && (Eu = n),
        n > Pu && (Pu = n)
    }
    function rc(t, n) {
        ...
        if (Du) {
            ...
            ku(i),
            i = xu(i);
            var o, a = t - zu, u = a > 0 ? 1 : -1, c = i[0] * Ya * u, f = Fa(a) > 180;
            f ^ (u * zu < c && c < u * t) ? (o = i[1] * Ya) > Pu && (Pu = o) : f ^ (u * zu < (c = (c + 360) % 360 - 180) && c < u * t) ? (o = -i[1] * Ya) < Eu && (Eu = o) : (n < Eu && (Eu = n),
            n > Pu && (Pu = n)),
            f ? t < zu ? fc(Tu, t) > fc(Tu, Cu) && (Cu = t) : fc(t, Cu) > fc(Tu, Cu) && (Tu = t) : Cu >= Tu ? (t < Tu && (Tu = t),
            t > Cu && (Cu = t)) : t > zu ? fc(Tu, t) > fc(Tu, Cu) && (Cu = t) : fc(t, Cu) > fc(Tu, Cu) && (Tu = t)
        } else
            Lu.push(Uu = [Tu = t, Cu = t]);
        n < Eu && (Eu = n),
        n > Pu && (Pu = n),
    ...
    function Cc(t) {
        function n(n) {
            return (n = t(n[0] * Ba, n[1] * Ba))[0] *= Ya,
            n[1] *= Ya,
            n
        }
        return t = Sc(t[0] * Ba, t[1] * Ba, t.length > 2 ? t[2] * Ba : 0),
        n.invert = function(n) {
            return (n = t.invert(n[0] * Ba, n[1] * Ba))[0] *= Ya,
            n[1] *= Ya,
            n
        }
        ,
        ...
        if (t.forEach(function(t) {
            if (!((n = t.length - 1) <= 0)) {
                ...
                if (qc(r, a)) {
                    ...
                    u.push(e = new Dc(r,t,null,!0)),
                    c.push(e.o = new Dc(r,null,e,!1)),
                    u.push(e = new Dc(a,t,null,!1)),
                    c.push(e.o = new Dc(a,null,e,!0))
            }
        }),
        u.length) {
            for (c.sort(n),
    ...
    function Yc(t, n) {
        var e = n[0]
          ...
          , u = 0;
        Oc.reset(),
        1 === i ? r = La + Ra : -1 === i && (r = -La - Ra);
        for (var c = 0, f = t.length; c < f; ++c)
            if (l = (s = t[c]).length)
                for (var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + Ua, v = Wa(p), g = ja(p), y = 0; y < l; ++y,
                d = b,
                v = x,
                g = w,
                h = _) {
                    var _ = s[y]
                      ...
                      , S = A > Da
                      , k = v * x;
                    if (Oc.add(Ha(k * N * Wa(A), g * w + k * ja(A))),
                    a += S ? M + N * Oa : M,
                    S ^ d >= e ^ b >= e) {
                        var T = Nu(wu(h), wu(_));
                        ku(T);
    ...
    function Bc(t, n, e, r) {
        return function(i) {
            var o, a, u, c = n(i), f = Rc(), s = n(f), l = !1, h = {
                point: d,
                lineStart: v,
                lineEnd: g,
                polygonStart: function() {
                ...
                polygonEnd: function() {
                    ...
                    l = !0),
                    Lc(a, Ic, t, e, i)) : t && (l || (i.polygonStart(),
                    l = !0),
                    i.lineStart(),
                    e(null, null, 1, i),
                    i.lineEnd()),
    ...
    var Hc = Bc(function() {
        ...
        return {
            ...
            point: function(o, a) {
                var u = o > 0 ? Da : -Da
                  , c = Fa(o - e);
                Fa(c - Da) < Ra ? (t.point(e, r = (r + a) / 2 > 0 ? La : -La),
                t.point(i, r),
                t.lineEnd(),
                t.lineStart(),
                t.point(u, r),
                t.point(o, r),
                n = 0) : i !== u && c >= Da && (Fa(e - i) < Ra && (e -= i * Ra),
                Fa(o - u) < Ra && (o -= u * Ra),
                r = function(t, n, e, r) {
                    var i, o, a = Wa(t - e);
    ...
    function jc(t) {
        ...
        function a(t, e, r) {
            ...
            if (!(g < 0)) {
                ...
                w = M,
                M = b),
                A || N < Ra ? A ? w + M > 0 ^ _[1] < (Fa(_[0] - m) < Ra ? w : M) : w <= _[1] && _[1] <= M : N > Da ^ (m <= _[0] && _[0] <= x)) {
                    var S = Su(d, (-p + y) / v);
                    return Au(S, h),
                    [_, xu(S)]
                }
        ...
        return Bc(o, function(t) {
            ...
            return {
                ...
                point: function(l, h) {
                    var d, p = [l, h], v = o(l, h), g = r ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? Da : -Da), h) : 0;
                    if (!n && (f = c = v) && t.lineStart(),
                    v !== c && (!(d = a(n, p)) || qc(n, d) || qc(p, d)) && (p[0] += Ra,
                    p[1] += Ra,
                    v = o(p[0], p[1])),
                    v !== c)
                        s = 0,
    ...
    function Vc(t, n, e, r) {
        ...
        return function(a) {
            var c, f, s, l, h, d, p, v, g, y, _, b = a, m = Rc(), x = {
                point: w,
                lineStart: function() {
                    x.point = M,
                    f && f.push(s = []);
    ...
    function yf() {
        ...
        function b() {
            return g(Xa(r / p) * p, e, p).map(s).concat(g(Xa(u / v) * v, a, v).map(l)).concat(g(Xa(n / h) * h, t, h).filter(function(t) {
                return Fa(t % p) > Ra
            }).map(c)).concat(g(Xa(o / d) * d, i, d).filter(function(t) {
                return Fa(t % v) > Ra
            }).map(f))
        }
        ...
        ,
        _.extentMajor([[-180, -90 + Ra], [180, 90 - Ra]]).extentMinor([[-180, -80 - Ra], [180, 80 + Ra]])
    }
    function _f(t) {
        return t
    }
    var bf, mf, xf, wf, Mf = Ea(), Nf = Ea(), Af = {
        point: eu,
        lineStart: eu,
        lineEnd: eu,
        polygonStart: function() {
        ...
        polygonEnd: function() {
            Af.lineStart = Af.lineEnd = Af.point = eu,
            Mf.add(Fa(Nf)),
            Nf.reset()
        },
        result: function() {
    ...
    var Cf = 1 / 0
      ...
      , qf = {
        ...
        result: function() {
            var t = [[Cf, Pf], [zf, Rf]];
            return zf = Rf = -(Pf = Cf = 1 / 0),
            t
        }
    };
    var Df, Lf, Uf, Of, Yf = 0, Bf = 0, Ff = 0, If = 0, Hf = 0, jf = 0, Xf = 0, Gf = 0, Vf = 0, $f = {
        point: Wf,
        lineStart: Zf,
        lineEnd: Kf,
        polygonStart: function() {
        ...
        result: function() {
            ...
            return Yf = Bf = Ff = If = Hf = jf = Xf = Gf = Vf = 0,
            t
        }
    };
    function Wf(t, n) {
    ...
    is.prototype = {
        ...
        point: function(t, n) {
            ...
            default:
                ...
                this._context.arc(t, n, this._radius, 0, Oa)
            }
        },
        result: eu
    };
    var os, as, us, cs, fs, ss = Ea(), ls = {
        point: eu,
        lineStart: function() {
            ls.point = hs
        },
    ...
    ps.prototype = {
        ...
        point: function(t, n) {
            ...
            case 1:
                ...
                break;
            default:
                null == this._circle && (this._circle = vs(this._radius)),
        ...
        return +n ? function(t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                ...
                if (b > 4 * n && v--) {
                    var m = a + h
                      ...
                      , C = T - i
                      , P = _ * E - y * C;
                    (P * P / b > n || Fa((y * E + _ * C) / b - .5) > .3 || a * h + u * d + c * p < Ns) && (e(r, i, o, a, u, c, k, T, A, m /= M, x /= M, w, v, g),
                    g.point(k, T),
            ...
            return function(n) {
                ...
                function _(r, i) {
                    var o = wu([r, i])
                      , a = t(r, i);
                    e(s, l, f, h, d, p, s = a[0], l = a[1], f = r, h = o[0], d = o[1], p = o[2], Ms, n),
                    n.point(s, l)
                }
                function b() {
                    v.point = g,
                ...
                function w() {
                    e(s, l, f, h, d, p, i, o, r, a, u, c, Ms, n),
                    v.lineEnd = b,
                    b()
                }
                return v
    ...
    function Es(t) {
        var n, e, r, i, o, a, u, c, f, s, l = 150, h = 480, d = 250, p = 0, v = 0, g = 0, y = 0, _ = 0, b = 0, m = null, x = Hc, w = null, M = _f, N = .5;
        function A(t) {
        ...
        return A.stream = function(t) {
            return f && s === t ? f : f = Ss(function(t) {
                return gs({
                    point: function(n, e) {
                        var r = t(n, e);
        ...
        A.clipAngle = function(t) {
            return arguments.length ? (x = +t ? jc(m = t * Ba) : (m = null,
            Hc),
            T()) : m * Ya
        }
        ,
        A.clipExtent = function(t) {
            return arguments.length ? (M = null == t ? (w = r = i = o = null,
            _f) : Vc(w = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]),
            T()) : null == w ? null : [[w, r], [i, o]]
        }
        ,
        A.scale = function(t) {
        ...
        ,
        A.center = function(t) {
            return arguments.length ? (p = t[0] % 360 * Ba,
            v = t[1] % 360 * Ba,
            k()) : [p * Ya, v * Ya]
        }
        ,
        A.rotate = function(t) {
            return arguments.length ? (g = t[0] % 360 * Ba,
            y = t[1] % 360 * Ba,
            _ = t.length > 2 ? t[2] % 360 * Ba : 0,
            k()) : [g * Ya, y * Ya, _ * Ya]
        }
        ,
        A.angle = function(t) {
            return arguments.length ? (b = t % 360 * Ba,
            k()) : b * Ya
        }
        ,
        A.precision = function(t) {
            return arguments.length ? (a = As(u, N = t * t),
            T()) : Qa(N)
        }
        ,
    ...
    function Rs() {
        return zs().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-.6, 38.7])
    }
    function qs(t) {
        return function(n, e) {
            var r = ja(n)
    ...
    function Ys(t) {
        var n, e, r, i = Ts(t), o = i.center, a = i.scale, u = i.translate, c = i.clipExtent, f = null;
        function s() {
            var o = Da * a()
              , u = i(Cc(i.rotate()).invert([0, 0]));
            return c(null == f ? [[u[0] - o, u[1] - o], [u[0] + o, u[1] + o]] : t === Os ? [[Math.max(u[0] - o, f), n], [Math.min(u[0] + o, e), r]] : [[f, Math.max(u[1] - o, n)], [e, Math.min(u[1] + o, r)]])
        }
    ...
    Ws.invert = function(t, n) {
        for (var e, r = n, i = r * r, o = i * i * i, a = 0; a < 12 && (o = (i = (r -= e = (r * (js + Xs * i + o * (Gs + Vs * i)) - n) / (js + 3 * Xs * i + o * (7 * Gs + 9 * Vs * i))) * r) * i * i,
        !(Fa(e) < qa)); ++a)
            ;
    ...
    function hl(t) {
        for (var n, e, r = 0, i = (t = function(t) {
            for (var n, e, r = t.length; r; )
                ...
                t[e] = n;
            return t
        }(ll.call(t))).length, o = []; r < i; )
            n = t[r],
            e && vl(e, n) ? ++r : (e = yl(o = dl(o, n)),
            r = 0);
        return e
    }
    function dl(t, n) {
        ...
        for (e = 0; e < t.length; ++e)
            if (pl(n, t[e]) && gl(_l(t[e], n), t))
                return [t[e], n];
        for (e = 0; e < t.length - 1; ++e)
            for (r = e + 1; r < t.length; ++r)
                if (pl(_l(t[e], t[r]), n) && pl(_l(t[e], n), t[r]) && pl(_l(t[r], n), t[e]) && gl(bl(t[e], t[r], n), t))
                    return [t[e], t[r], n];
        throw new Error
    }
    function pl(t, n) {
    ...
    function Vl(t, n, e, r, i, o) {
        for (var a, u, c, f, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
            ...
            a.dice ? Rl(a, e, r, i, w ? r += f * s / w : o) : Xl(a, e, r, w ? e += c * s / w : i, o),
            w -= s,
            b = m
        }
        return y
        ...
        function e(t, e, r, i, o) {
            if ((a = t._squarify) && a.ratio === n)
                for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
                    ...
                    s = c.length; f < s; ++f)
                        u.value += c[f].value;
                    u.dice ? Rl(u, e, r, i, r += (o - r) * u.value / d) : Xl(u, e, r, e += (i - e) * u.value / d, o),
                    d -= u.value
                }
            else
                t._squarify = a = Vl(n, t, e, r, i, o),
                a.ratio = n
        }
        return e.ratio = function(n) {
            return t((n = +n) > 1 ? n : 1)
    ...
    function lh() {
        ...
        ,
        i.range = function(t) {
            return arguments.length ? (e = fh.call(t),
            i) : e.slice()
        }
        ,
    ...
    function hh() {
        var t, n, e = lh().unknown(void 0), r = e.domain, i = e.range, o = [0, 1], a = !1, u = 0, c = 0, f = .5;
        function s() {
            var e = r().length
              , s = o[1] < o[0]
              , l = o[s - 0]
        ...
        e.padding = function(t) {
            return arguments.length ? (u = Math.min(1, c = +t),
            s()) : u
        }
        ,
    ...
    function xh() {
        var t, n, e, r, i, o, a = ph, u = ph, c = ye, f = vh;
        function s() {
            return r = Math.min(a.length, u.length) > 2 ? bh : _h,
            i = o = null,
            l
        }
        function l(n) {
        ...
        ,
        l.domain = function(t) {
            return arguments.length ? (a = ch.call(t, dh),
            f === vh || (f = yh(a)),
            s()) : a.slice()
        }
        ,
        l.range = function(t) {
            return arguments.length ? (u = fh.call(t),
            s()) : u.slice()
        }
        ,
        ...
        ,
        l.clamp = function(t) {
            return arguments.length ? (f = t ? yh(a) : vh,
            l) : f !== vh
        }
        ,
    ...
    function Mh(n, e, r, i) {
        ...
        case "s":
            ...
            return null != i.precision || isNaN(o = ka(a, u)) || (i.precision = o),
            t.formatPrefix(i, u);
        case "":
        case "e":
        case "g":
    ...
    function zh(n) {
        var e, r, i = n(Sh, kh), o = i.domain, a = 10;
        function u() {
            return e = function(t) {
            ...
            r = function(t) {
                return 10 === t ? Ch : t === Math.E ? Math.exp : function(n) {
                    return Math.pow(t, n)
                }
            }(a),
            o()[0] < 0 ? (e = Ph(e),
    ...
    function Yh(t) {
        ...
        return n.exponent = function(n) {
            return arguments.length ? 1 === (e = +n) ? t(vh, vh) : .5 === e ? t(Uh, Oh) : t(Lh(e), Lh(1 / e)) : e
        }
        ,
        Nh(n)
    }
    ...
    var jh = Hh(function() {}, function(t, n) {
        t.setTime(+t + n)
    }, function(t, n) {
        return n - t
    });
    jh.every = function(t) {
        return t = Math.floor(t),
        isFinite(t) && t > 0 ? t > 1 ? Hh(function(n) {
    ...
    bd.every = function(t) {
        return isFinite(t = Math.floor(t)) && t > 0 ? Hh(function(n) {
        ...
        var n = t.dateTime
          ...
          , x = {
            ...
            p: function(t, n, e) {
                ...
                return r ? (t.p = s[r[0].toLowerCase()],
                e + r[0].length) : -1
            },
            Q: wp,
            s: Mp,
        ...
        function w(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f; )
                    ...
                    null != (i = Qd[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0",
                    (o = n[r]) && (r = o(e, i)),
                    a.push(r),
                    c = u + 1);
            ...
            return function(e) {
                ...
                "V"in o) {
                    if (o.V < 1 || o.V > 53)
                        return null;
                    "w"in o || (o.w = 1),
                    "Z"in o ? (i = (r = Vd($d(o.y))).getUTCDay(),
                    r = i > 4 || 0 === i ? Ed.ceil(r) : Ed(r),
                    r = Ad.offset(r, 7 * (o.V - 1)),
                    o.y = r.getUTCFullYear(),
                    o.m = r.getUTCMonth(),
                    o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = n($d(o.y))).getDay(),
                    r = i > 4 || 0 === i ? id.ceil(r) : id(r),
                    ...
                    i = "Z"in o ? Vd($d(o.y)).getUTCDay() : n($d(o.y)).getDay(),
                    o.m = 0,
        ...
        function N(t, n, e, r) {
            for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
                ...
                if (37 === (i = n.charCodeAt(a++))) {
                    if (i = n.charAt(a++),
                    !(o = x[i in Qd ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
                        return -1
    ...
    function Dp(t, n) {
        var e = t.getDay();
        return t = e >= 4 || 0 === e ? ud(t) : ud.ceil(t),
        np(ud.count(bd(t), t) + (4 === bd(t).getDay()), n, 2)
    }
    function Lp(t) {
        return t.getDay()
    }
    ...
    function Jp(t, n) {
        var e = t.getUTCDay();
        return t = e >= 4 || 0 === e ? zd(t) : zd.ceil(t),
        np(zd.count(jd(t), t) + (4 === jd(t).getUTCDay()), n, 2)
    }
    function Kp(t) {
        return t.getUTCDay()
    }
    ...
    function uv(n) {
        return Zd = Wd(n),
        t.timeFormat = Zd.format,
        t.timeParse = Zd.parse,
        t.utcFormat = Zd.utcFormat,
        t.utcParse = Zd.utcParse,
        Zd
    }
    uv({
        dateTime: "%x, %X",
    ...
    var cv = Date.prototype.toISOString ? function(t) {
    ...
    function bv(t, n, r, i, o, a, u, c, f) {
        var s = wh(vh, vh)
          ...
          , b = f("%B")
          , m = f("%Y")
          , x = [[u, 1, sv], [u, 5, 5 * sv], [u, 15, 15 * sv], [u, 30, 30 * sv], [a, 1, lv], [a, 5, 5 * lv], [a, 15, 15 * lv], [a, 30, 30 * lv], [o, 1, hv], [o, 3, 3 * hv], [o, 6, 6 * hv], [o, 12, 12 * hv], [i, 1, dv], [i, 2, 2 * dv], [r, 1, pv], [n, 1, vv], [n, 3, 3 * vv], [t, 1, gv]];
        function M(e) {
        ...
        function N(n, r, i, o) {
            ...
            "number" == typeof n) {
                ...
                u === x.length ? (o = w(r / gv, i / gv, n),
                n = t) : u ? (o = (u = x[a / x[u - 1][2] < x[u][2] / a ? u - 1 : u])[1],
                n = u[0]) : (o = Math.max(w(r, i, n), 1),
                n = c)
            }
    ...
    function mv() {
        var t, n, e, r, i, o = 0, a = 1, u = vh, c = !1;
        function f(n) {
            return isNaN(n = +n) ? i : u(0 === e ? .5 : (n = (r(n) - t) * e,
            c ? Math.max(0, Math.min(1, n)) : n))
        }
        return f.domain = function(i) {
            return arguments.length ? (t = r(o = +i[0]),
            n = r(a = +i[1]),
            e = t === n ? 0 : 1 / (n - t),
            f) : [o, a]
        }
    ...
    function Mv() {
        var t, n, e, r, i, o, a, u = 0, c = .5, f = 1, s = vh, l = !1;
        function h(t) {
    ...
    var Lv = new Array(3).concat("d8b365f5f5f55ab4ac", "a6611adfc27d80cdc1018571", "a6611adfc27df5f5f580cdc1018571", "8c510ad8b365f6e8c3c7eae55ab4ac01665e", "8c510ad8b365f6e8c3f5f5f5c7eae55ab4ac01665e", "8c510abf812ddfc27df6e8c3c7eae580cdc135978f01665e", "8c510abf812ddfc27df6e8c3f5f5f5c7eae580cdc135978f01665e", "5430058c510abf812ddfc27df6e8c3c7eae580cdc135978f01665e003c30", "5430058c510abf812ddfc27df6e8c3f5f5f5c7eae580cdc135978f01665e003c30").map(Av)
      , Uv = Dv(Lv)
      , Ov = new Array(3).concat("af8dc3f7f7f77fbf7b", "7b3294c2a5cfa6dba0008837", "7b3294c2a5cff7f7f7a6dba0008837", "762a83af8dc3e7d4e8d9f0d37fbf7b1b7837", "762a83af8dc3e7d4e8f7f7f7d9f0d37fbf7b1b7837", "762a839970abc2a5cfe7d4e8d9f0d3a6dba05aae611b7837", "762a839970abc2a5cfe7d4e8f7f7f7d9f0d3a6dba05aae611b7837", "40004b762a839970abc2a5cfe7d4e8d9f0d3a6dba05aae611b783700441b", "40004b762a839970abc2a5cfe7d4e8f7f7f7d9f0d3a6dba05aae611b783700441b").map(Av)
      , Yv = Dv(Ov)
      , Bv = new Array(3).concat("e9a3c9f7f7f7a1d76a", "d01c8bf1b6dab8e1864dac26", "d01c8bf1b6daf7f7f7b8e1864dac26", "c51b7de9a3c9fde0efe6f5d0a1d76a4d9221", "c51b7de9a3c9fde0eff7f7f7e6f5d0a1d76a4d9221", "c51b7dde77aef1b6dafde0efe6f5d0b8e1867fbc414d9221", "c51b7dde77aef1b6dafde0eff7f7f7e6f5d0b8e1867fbc414d9221", "8e0152c51b7dde77aef1b6dafde0efe6f5d0b8e1867fbc414d9221276419", "8e0152c51b7dde77aef1b6dafde0eff7f7f7e6f5d0b8e1867fbc414d9221276419").map(Av)
      , Fv = Dv(Bv)
      , Iv = new Array(3).concat("998ec3f7f7f7f1a340", "5e3c99b2abd2fdb863e66101", "5e3c99b2abd2f7f7f7fdb863e66101", "542788998ec3d8daebfee0b6f1a340b35806", "542788998ec3d8daebf7f7f7fee0b6f1a340b35806", "5427888073acb2abd2d8daebfee0b6fdb863e08214b35806", "5427888073acb2abd2d8daebf7f7f7fee0b6fdb863e08214b35806", "2d004b5427888073acb2abd2d8daebfee0b6fdb863e08214b358067f3b08", "2d004b5427888073acb2abd2d8daebf7f7f7fee0b6fdb863e08214b358067f3b08").map(Av)
      , Hv = Dv(Iv)
      ...
      , Xv = Dv(jv)
      , Gv = new Array(3).concat("ef8a62ffffff999999", "ca0020f4a582bababa404040", "ca0020f4a582ffffffbababa404040", "b2182bef8a62fddbc7e0e0e09999994d4d4d", "b2182bef8a62fddbc7ffffffe0e0e09999994d4d4d", "b2182bd6604df4a582fddbc7e0e0e0bababa8787874d4d4d", "b2182bd6604df4a582fddbc7ffffffe0e0e0bababa8787874d4d4d", "67001fb2182bd6604df4a582fddbc7e0e0e0bababa8787874d4d4d1a1a1a", "67001fb2182bd6604df4a582fddbc7ffffffe0e0e0bababa8787874d4d4d1a1a1a").map(Av)
      , Vv = Dv(Gv)
      , $v = new Array(3).concat("fc8d59ffffbf91bfdb", "d7191cfdae61abd9e92c7bb6", "d7191cfdae61ffffbfabd9e92c7bb6", "d73027fc8d59fee090e0f3f891bfdb4575b4", "d73027fc8d59fee090ffffbfe0f3f891bfdb4575b4", "d73027f46d43fdae61fee090e0f3f8abd9e974add14575b4", "d73027f46d43fdae61fee090ffffbfe0f3f8abd9e974add14575b4", "a50026d73027f46d43fdae61fee090e0f3f8abd9e974add14575b4313695", "a50026d73027f46d43fdae61fee090ffffbfe0f3f8abd9e974add14575b4313695").map(Av)
      , Wv = Dv($v)
      , Zv = new Array(3).concat("fc8d59ffffbf91cf60", "d7191cfdae61a6d96a1a9641", "d7191cfdae61ffffbfa6d96a1a9641", "d73027fc8d59fee08bd9ef8b91cf601a9850", "d73027fc8d59fee08bffffbfd9ef8b91cf601a9850", "d73027f46d43fdae61fee08bd9ef8ba6d96a66bd631a9850", "d73027f46d43fdae61fee08bffffbfd9ef8ba6d96a66bd631a9850", "a50026d73027f46d43fdae61fee08bd9ef8ba6d96a66bd631a9850006837", "a50026d73027f46d43fdae61fee08bffffbfd9ef8ba6d96a66bd631a9850006837").map(Av)
      , Qv = Dv(Zv)
      , Jv = new Array(3).concat("fc8d59ffffbf99d594", "d7191cfdae61abdda42b83ba", "d7191cfdae61ffffbfabdda42b83ba", "d53e4ffc8d59fee08be6f59899d5943288bd", "d53e4ffc8d59fee08bffffbfe6f59899d5943288bd", "d53e4ff46d43fdae61fee08be6f598abdda466c2a53288bd", "d53e4ff46d43fdae61fee08bffffbfe6f598abdda466c2a53288bd", "9e0142d53e4ff46d43fdae61fee08be6f598abdda466c2a53288bd5e4fa2", "9e0142d53e4ff46d43fdae61fee08bffffbfe6f598abdda466c2a53288bd5e4fa2").map(Av)
      , Kv = Dv(Jv)
      , tg = new Array(3).concat("e5f5f999d8c92ca25f", "edf8fbb2e2e266c2a4238b45", "edf8fbb2e2e266c2a42ca25f006d2c", "edf8fbccece699d8c966c2a42ca25f006d2c", "edf8fbccece699d8c966c2a441ae76238b45005824", "f7fcfde5f5f9ccece699d8c966c2a441ae76238b45005824", "f7fcfde5f5f9ccece699d8c966c2a441ae76238b45006d2c00441b").map(Av)
      , ng = Dv(tg)
      , eg = new Array(3).concat("e0ecf49ebcda8856a7", "edf8fbb3cde38c96c688419d", "edf8fbb3cde38c96c68856a7810f7c", "edf8fbbfd3e69ebcda8c96c68856a7810f7c", "edf8fbbfd3e69ebcda8c96c68c6bb188419d6e016b", "f7fcfde0ecf4bfd3e69ebcda8c96c68c6bb188419d6e016b", "f7fcfde0ecf4bfd3e69ebcda8c96c68c6bb188419d810f7c4d004b").map(Av)
      , rg = Dv(eg)
      , ig = new Array(3).concat("e0f3dba8ddb543a2ca", "f0f9e8bae4bc7bccc42b8cbe", "f0f9e8bae4bc7bccc443a2ca0868ac", "f0f9e8ccebc5a8ddb57bccc443a2ca0868ac", "f0f9e8ccebc5a8ddb57bccc44eb3d32b8cbe08589e", "f7fcf0e0f3dbccebc5a8ddb57bccc44eb3d32b8cbe08589e", "f7fcf0e0f3dbccebc5a8ddb57bccc44eb3d32b8cbe0868ac084081").map(Av)
      , og = Dv(ig)
      , ag = new Array(3).concat("fee8c8fdbb84e34a33", "fef0d9fdcc8afc8d59d7301f", "fef0d9fdcc8afc8d59e34a33b30000", "fef0d9fdd49efdbb84fc8d59e34a33b30000", "fef0d9fdd49efdbb84fc8d59ef6548d7301f990000", "fff7ecfee8c8fdd49efdbb84fc8d59ef6548d7301f990000", "fff7ecfee8c8fdd49efdbb84fc8d59ef6548d7301fb300007f0000").map(Av)
      , ug = Dv(ag)
      , cg = new Array(3).concat("ece2f0a6bddb1c9099", "f6eff7bdc9e167a9cf02818a", "f6eff7bdc9e167a9cf1c9099016c59", "f6eff7d0d1e6a6bddb67a9cf1c9099016c59", "f6eff7d0d1e6a6bddb67a9cf3690c002818a016450", "fff7fbece2f0d0d1e6a6bddb67a9cf3690c002818a016450", "fff7fbece2f0d0d1e6a6bddb67a9cf3690c002818a016c59014636").map(Av)
      , fg = Dv(cg)
      , sg = new Array(3).concat("ece7f2a6bddb2b8cbe", "f1eef6bdc9e174a9cf0570b0", "f1eef6bdc9e174a9cf2b8cbe045a8d", "f1eef6d0d1e6a6bddb74a9cf2b8cbe045a8d", "f1eef6d0d1e6a6bddb74a9cf3690c00570b0034e7b", "fff7fbece7f2d0d1e6a6bddb74a9cf3690c00570b0034e7b", "fff7fbece7f2d0d1e6a6bddb74a9cf3690c00570b0045a8d023858").map(Av)
      , lg = Dv(sg)
      , hg = new Array(3).concat("e7e1efc994c7dd1c77", "f1eef6d7b5d8df65b0ce1256", "f1eef6d7b5d8df65b0dd1c77980043", "f1eef6d4b9dac994c7df65b0dd1c77980043", "f1eef6d4b9dac994c7df65b0e7298ace125691003f", "f7f4f9e7e1efd4b9dac994c7df65b0e7298ace125691003f", "f7f4f9e7e1efd4b9dac994c7df65b0e7298ace125698004367001f").map(Av)
      , dg = Dv(hg)
      , pg = new Array(3).concat("fde0ddfa9fb5c51b8a", "feebe2fbb4b9f768a1ae017e", "feebe2fbb4b9f768a1c51b8a7a0177", "feebe2fcc5c0fa9fb5f768a1c51b8a7a0177", "feebe2fcc5c0fa9fb5f768a1dd3497ae017e7a0177", "fff7f3fde0ddfcc5c0fa9fb5f768a1dd3497ae017e7a0177", "fff7f3fde0ddfcc5c0fa9fb5f768a1dd3497ae017e7a017749006a").map(Av)
      , vg = Dv(pg)
      , gg = new Array(3).concat("edf8b17fcdbb2c7fb8", "ffffcca1dab441b6c4225ea8", "ffffcca1dab441b6c42c7fb8253494", "ffffccc7e9b47fcdbb41b6c42c7fb8253494", "ffffccc7e9b47fcdbb41b6c41d91c0225ea80c2c84", "ffffd9edf8b1c7e9b47fcdbb41b6c41d91c0225ea80c2c84", "ffffd9edf8b1c7e9b47fcdbb41b6c41d91c0225ea8253494081d58").map(Av)
      , yg = Dv(gg)
      , _g = new Array(3).concat("f7fcb9addd8e31a354", "ffffccc2e69978c679238443", "ffffccc2e69978c67931a354006837", "ffffccd9f0a3addd8e78c67931a354006837", "ffffccd9f0a3addd8e78c67941ab5d238443005a32", "ffffe5f7fcb9d9f0a3addd8e78c67941ab5d238443005a32", "ffffe5f7fcb9d9f0a3addd8e78c67941ab5d238443006837004529").map(Av)
      , bg = Dv(_g)
      , mg = new Array(3).concat("fff7bcfec44fd95f0e", "ffffd4fed98efe9929cc4c02", "ffffd4fed98efe9929d95f0e993404", "ffffd4fee391fec44ffe9929d95f0e993404", "ffffd4fee391fec44ffe9929ec7014cc4c028c2d04", "ffffe5fff7bcfee391fec44ffe9929ec7014cc4c028c2d04", "ffffe5fff7bcfee391fec44ffe9929ec7014cc4c02993404662506").map(Av)
      , xg = Dv(mg)
      , wg = new Array(3).concat("ffeda0feb24cf03b20", "ffffb2fecc5cfd8d3ce31a1c", "ffffb2fecc5cfd8d3cf03b20bd0026", "ffffb2fed976feb24cfd8d3cf03b20bd0026", "ffffb2fed976feb24cfd8d3cfc4e2ae31a1cb10026", "ffffccffeda0fed976feb24cfd8d3cfc4e2ae31a1cb10026", "ffffccffeda0fed976feb24cfd8d3cfc4e2ae31a1cbd0026800026").map(Av)
      , Mg = Dv(wg)
      , Ng = new Array(3).concat("deebf79ecae13182bd", "eff3ffbdd7e76baed62171b5", "eff3ffbdd7e76baed63182bd08519c", "eff3ffc6dbef9ecae16baed63182bd08519c", "eff3ffc6dbef9ecae16baed64292c62171b5084594", "f7fbffdeebf7c6dbef9ecae16baed64292c62171b5084594", "f7fbffdeebf7c6dbef9ecae16baed64292c62171b508519c08306b").map(Av)
      , Ag = Dv(Ng)
      , Sg = new Array(3).concat("e5f5e0a1d99b31a354", "edf8e9bae4b374c476238b45", "edf8e9bae4b374c47631a354006d2c", "edf8e9c7e9c0a1d99b74c47631a354006d2c", "edf8e9c7e9c0a1d99b74c47641ab5d238b45005a32", "f7fcf5e5f5e0c7e9c0a1d99b74c47641ab5d238b45005a32", "f7fcf5e5f5e0c7e9c0a1d99b74c47641ab5d238b45006d2c00441b").map(Av)
      , kg = Dv(Sg)
      , Tg = new Array(3).concat("f0f0f0bdbdbd636363", "f7f7f7cccccc969696525252", "f7f7f7cccccc969696636363252525", "f7f7f7d9d9d9bdbdbd969696636363252525", "f7f7f7d9d9d9bdbdbd969696737373525252252525", "fffffff0f0f0d9d9d9bdbdbd969696737373525252252525", "fffffff0f0f0d9d9d9bdbdbd969696737373525252252525000000").map(Av)
      , Eg = Dv(Tg)
      , Cg = new Array(3).concat("efedf5bcbddc756bb1", "f2f0f7cbc9e29e9ac86a51a3", "f2f0f7cbc9e29e9ac8756bb154278f", "f2f0f7dadaebbcbddc9e9ac8756bb154278f", "f2f0f7dadaebbcbddc9e9ac8807dba6a51a34a1486", "fcfbfdefedf5dadaebbcbddc9e9ac8807dba6a51a34a1486", "fcfbfdefedf5dadaebbcbddc9e9ac8807dba6a51a354278f3f007d").map(Av)
      , Pg = Dv(Cg)
      , zg = new Array(3).concat("fee0d2fc9272de2d26", "fee5d9fcae91fb6a4acb181d", "fee5d9fcae91fb6a4ade2d26a50f15", "fee5d9fcbba1fc9272fb6a4ade2d26a50f15", "fee5d9fcbba1fc9272fb6a4aef3b2ccb181d99000d", "fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181d99000d", "fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181da50f1567000d").map(Av)
      , Rg = Dv(zg)
      , qg = new Array(3).concat("fee6cefdae6be6550d", "feeddefdbe85fd8d3cd94701", "feeddefdbe85fd8d3ce6550da63603", "feeddefdd0a2fdae6bfd8d3ce6550da63603", "feeddefdd0a2fdae6bfd8d3cf16913d948018c2d04", "fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d948018c2d04", "fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d94801a636037f2704").map(Av)
      , Dg = Dv(qg)
      , Lg = He(Zn(300, .5, 0), Zn(-240, .5, 1))
      , Ug = He(Zn(-100, .75, .35), Zn(80, 1.5, .8))
      , Og = He(Zn(260, .75, .35), Zn(80, 1.5, .8))
      , Yg = Zn();
    var Bg = gn()
      , Fg = Math.PI / 3
      , Ig = 2 * Math.PI / 3;
    ...
    var jg = Hg(Av(""))
      , Xg = Hg(Av(""))
      , Gg = Hg(Av(""))
      , Vg = Hg(Av(""));
    function $g(t) {
        return function() {
            return t
        }
    ...
    function yy() {
        ...
        ,
        a.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : $g(+t),
            a) : n
        }
        ,
        a.defined = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : $g(!!t),
            a) : e
        }
        ,
        a.curve = function(t) {
    ...
    function _y() {
        ...
        return c.x = function(e) {
            return arguments.length ? (t = "function" == typeof e ? e : $g(+e),
            n = null,
            c) : t
        }
        ,
        ...
        ,
        c.x1 = function(t) {
            return arguments.length ? (n = null == t ? null : "function" == typeof t ? t : $g(+t),
            c) : n
        }
        ,
        c.y = function(t) {
        ...
        ,
        c.y1 = function(t) {
            return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : $g(+t),
            c) : r
        }
        ,
        ...
        c.defined = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : $g(!!t),
            c) : i
        }
        ,
        c.curve = function(t) {
    ...
    function Py(t) {
        var n = Ey
          ...
          , o = null;
        function a() {
            var a, u = Ty.call(arguments), c = n.apply(this, u), f = e.apply(this, u);
            if (o || (o = a = ji()),
            t(o, +r.apply(this, (u[0] = c,
            u)), +i.apply(this, u), +r.apply(this, (u[0] = f,
            u)), +i.apply(this, u)),
            a)
                return o = null,
                a + "" || null
        ...
        ,
        a.x = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : $g(+t),
            a) : r
        }
        ,
        a.y = function(t) {
    ...
    var Dy = {
      ...
      , Zy = {
        draw: function(t, n) {
            ...
            t.lineTo(o, a),
            t.lineTo(u, c),
            t.lineTo(-.5 * r - Vy * i, Vy * r + -.5 * i),
            t.lineTo(-.5 * o - Vy * a, Vy * o + -.5 * a),
            t.lineTo(-.5 * u - Vy * c, Vy * u + -.5 * c),
            t.lineTo(-.5 * r + Vy * i, -.5 * i - Vy * r),
            t.lineTo(-.5 * o + Vy * a, -.5 * a - Vy * o),
            t.lineTo(-.5 * u + Vy * c, -.5 * c - Vy * u),
            t.closePath()
        }
    }
    ...
    function x_(t, n, e) {
        var r = t._x1 - t._x0
          ...
          , a = (e - t._y1) / (i || r < 0 && -0)
          , u = (o * i + a * r) / (r + i);
        return (m_(o) + m_(a)) * Math.min(Math.abs(o), Math.abs(a), .5 * Math.abs(u)) || 0
    }
    function w_(t, n) {
        var e = t._x1 - t._x0;
    ...
    function X_(t, n, e, r) {
        ...
        e && V_(i, t, n, e),
        r && V_(i, n, t, r),
        db[t.index].halfedges.push(o),
        db[n.index].halfedges.push(o),
        i
    }
    function G_(t, n, e) {
        var r = [n, e];
            ...
            h || !(o < 0)) {
                ...
                d || !(o > 0)) {
                    ...
                    d || !(o < 0)) {
                        ...
                        return !(s > 0 || l < 1) || (s > 0 && (t[0] = [c + s * h, f + s * d]),
                        l < 1 && (t[1] = [c + l * h, f + l * d]),
                        !0)
                    }
                }
    ...
    N_.prototype = {
        ...
        point: function(t, n) {
            ...
            (t = +t) !== this._x1 || n !== this._y1) {
                ...
                case 2:
                    this._point = 3,
                    M_(this, w_(this, e = x_(this, t, n)), e);
                    break;
                default:
        ...
        lineEnd: function() {
            ...
            if (e)
                ...
                2 === e)
                    ...
                    for (var r = T_(t), i = T_(n), o = 0, a = 1; a < e; ++o,
                    ++a)
    ...
    function cb(t) {
        var n = t.circle
          ...
          , u = [t];
        ub(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < gb && Math.abs(r - c.circle.cy) < gb; )
            o = c.P,
            u.unshift(c),
            ub(c),
            c = o;
        u.unshift(c),
        rb(c);
        for (var f = a; f.circle && Math.abs(e - f.circle.x) < gb && Math.abs(r - f.circle.cy) < gb; )
            a = f.N,
            u.push(f),
            ub(f),
            f = a;
        ...
        for (s = 1; s < l; ++s)
            f = u[s],
            c = u[s - 1],
            V_(f.edge, c.site, f.site, i);
        c = u[0],
        (f = u[l - 1]).edge = X_(c.site, f.site, null, i),
        eb(c),
        eb(f)
    }
    function fb(t) {
        ...
        n || e) {
            ...
            if (e) {
                ...
                V_(e.edge, f, p, m),
                c.edge = X_(f, t, null, m),
                e.edge = X_(t, p, null, m),
                eb(n),
                eb(e)
            } else
                c.edge = X_(n.site, c.site)
        }
    }
    function sb(t, n) {
        var e = t.site
    ...
    var hb, db, pb, vb, gb = 1e-6, yb = 1e-12;
    function _b(t, n) {
        return n[1] - t[1] || n[0] - t[0]
    }
    function bb(t, n) {
        var e, r, i, o = t.sort(_b).pop();
        for (vb = [],
        db = new Array(t.length),
        hb = new B_,
        pb = new B_; ; )
            if (i = K_,
        ...
        n) {
            var a = +n[0][0]
              ...
              , f = +n[1][1];
            !function(t, n, e, r) {
                for (var i, o = vb.length; o--; )
                    W_(i = vb[o], t, n, e, r) && $_(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > gb || Math.abs(i[0][1] - i[1][1]) > gb) || delete vb[o]
            }(a, u, c, f),
            function(t, n, e, r) {
                var i, o, a, u, c, f, s, l, h, d, p, v, g = db.length, y = !0;
                for (i = 0; i < g; ++i)
                    if (o = db[i]) {
                        for (a = o.site,
                        ...
                        f = c.length; u < f; )
                            ...
                            l = (s = Q_(o, vb[c[++u % f]]))[0],
                            h = s[1],
                            (Math.abs(p - l) > gb || Math.abs(v - h) > gb) && (c.splice(u, 0, vb.push(G_(a, d, Math.abs(p - t) < gb && r - v > gb ? [t, Math.abs(l - t) < gb ? h : r] : Math.abs(v - r) < gb && e - p > gb ? [Math.abs(h - r) < gb ? l : e, r] : Math.abs(p - e) < gb && v - n > gb ? [e, Math.abs(l - e) < gb ? h : n] : Math.abs(v - n) < gb && p - t > gb ? [Math.abs(h - n) < gb ? l : t, n] : null)) - 1),
                            ++f);
                        f && (y = !1)
                    }
                if (y) {
                    ...
                    for (i = 0,
                    y = null; i < g; ++i)
                        (o = db[i]) && (m = (_ = (a = o.site)[0] - t) * _ + (b = a[1] - n) * b) < x && (x = m,
                        y = o);
                    if (y) {
                        var w = [t, n]
                          , M = [t, r]
                ...
                for (i = 0; i < g; ++i)
                    (o = db[i]) && (o.halfedges.length || delete db[i])
            }(a, u, c, f)
        }
        this.edges = vb,
        this.cells = db,
            ...
            return this.cells.forEach(function(e, r) {
                if (o = (i = e.halfedges).length)
                    for (var i, o, a, u, c, f, s = e.site, l = -1, h = n[i[o - 1]], d = h.left === s ? h.right : h.left; ++l < o; )
                        ...
                        a && d && r < a.index && r < d.index && (c = a,
                        f = d,
                        ((u = s)[0] - f[0]) * (c[1] - u[1]) - (u[0] - c[0]) * (f[1] - u[1]) < 0) && t.push([s.data, a.data, d.data])
            }),
            t
        },
        links: function() {
    ...
    t.histogram = function() {
        ...
        function r(r) {
            ...
            var f = n(c)
              ...
              , l = f[1]
              , h = e(c, s, l);
            Array.isArray(h) || (h = w(s, l, h),
            h = g(Math.ceil(s / h) * h, l, h));
        ...
        return r.value = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : p(n),
            r) : t
        }
        ,
        r.domain = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : p([t[0], t[1]]),
            r) : n
        }
        ,
    ...
    t.chord = function() {
        ...
        return i.padAngle = function(n) {
            return arguments.length ? (t = Ui(0, n),
            i) : t
        }
        ,
        ...
        i.sortChords = function(t) {
            return arguments.length ? (null == t ? r = null : (n = t,
            r = function(t, e) {
    ...
    t.ribbon = function() {
        var t = Xi
          ...
          , o = null;
        function a() {
            var a, u = Oi.call(arguments), c = t.apply(this, u), f = n.apply(this, u), s = +e.apply(this, (u[0] = c,
            u)), l = r.apply(this, u) - Di, h = i.apply(this, u) - Di, d = s * zi(l), p = s * Ri(l), v = +e.apply(this, (u[0] = f,
            u)), g = r.apply(this, u) - Di, y = i.apply(this, u) - Di;
            if (o || (o = a = ji()),
            o.moveTo(d, p),
            o.arc(0, 0, s, l, h),
            l === g && h === y || (o.quadraticCurveTo(0, 0, v * zi(g), v * Ri(g)),
            o.arc(0, 0, v, g, y)),
        ...
        return a.radius = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Yi(+t),
            a) : e
        }
        ,
        ...
        a.endAngle = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Yi(+t),
            a) : i
        }
        ,
        a.source = function(n) {
            ...
            entries: function(t) {
                return function t(e, o) {
                    if (++o > r.length)
                        return e;
                    var a, u = i[o - 1];
                    return null != n && o >= r.length ? a = e.entries() : (a = [],
                    e.each(function(n, e) {
                        a.push({
                            key: e,
                            values: t(n, o)
    ...
    t.contourDensity = function() {
        ...
        function l(r) {
            ...
            if (!Array.isArray(d)) {
                var p = A(i);
                d = w(0, p, d),
                (d = g(0, Math.floor(p / d) * d, d)).shift()
            }
        ...
        return l.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : uo(+n),
            l) : t
        }
        ,
        l.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : uo(+t),
            l) : n
        }
        ,
        l.weight = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : uo(+t),
            l) : e
        }
        ,
        l.size = function(t) {
        ...
        l.thresholds = function(t) {
            return arguments.length ? (s = "function" == typeof t ? t : Array.isArray(t) ? uo(oo.call(t)) : uo(t),
            l) : s
        }
        ,
    ...
    t.drag = function() {
        ...
        function p() {
            if (!i && o.apply(this, arguments)) {
                ...
                u && (zt(t.event.view).on("mousemove.drag", v, !0).on("mouseup.drag", g, !0),
                It(t.event.view),
                Bt(),
                r = !1,
                n = t.event.clientX,
        ...
        function y() {
            if (o.apply(this, arguments)) {
                ...
                for (n = 0; n < u; ++n)
                    (e = m(r[n].identifier, i, Yt, this, arguments)) && (Bt(),
                    e("start"))
            }
        }
        function _() {
        ...
        function b() {
            ...
            n = 0; n < o; ++n)
                (e = f[r[n].identifier]) && (Bt(),
                e("end"))
        }
        function m(n, e, r, i, o) {
            var a, c, h, p = r(e, n), v = s.copy();
            if (kt(new Xt(d,"beforestart",a,n,l,p[0],p[1],0,0,v), function() {
                return null != (t.event.subject = a = u.apply(i, o)) && (c = a.x - p[0] || 0,
                h = a.y - p[1] || 0,
                !0)
            }))
                return function t(u) {
        ...
        return d.filter = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : jt(!!t),
            d) : o
        }
        ,
        d.container = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : jt(t),
            d) : a
        }
        ,
        d.subject = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : jt(t),
            d) : u
        }
        ,
        d.touchable = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : jt(!!t),
            d) : c
        }
        ,
        d.on = function() {
    ...
    t.forceCollide = function(t) {
        ...
        function o() {
            ...
            function p(t, n, e, i, o) {
                var a = t.data
                  ...
                  , d = s + h;
                if (!a)
                    return n > c + d || i < c - d || e > f + d || o < f - d;
                if (a.index > u.index) {
                    var p = c - a.x - a.vx
                      , v = f - a.y - a.vy
                      , g = p * p + v * v;
        ...
        return "function" != typeof t && (t = Wo(null == t ? 1 : +t)),
        ...
        ,
        o.radius = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : Wo(+n),
            u(),
            o) : t
        }
        ,
    ...
    t.forceLink = function(t) {
        var n, e, r, i, o, a = ua, u = function(t) {
        ...
        s.strength = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : Wo(+t),
            h(),
            s) : u
        }
        ,
        s.distance = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : Wo(+t),
            d(),
            s) : c
        }
        ,
    ...
    t.forceManyBody = function() {
        var t, n, e, r, i = Wo(-30), o = 1, a = 1 / 0, u = .81;
        function c(r) {
            var i, o = t.length, a = na(t, fa, sa).visitAfter(s);
            for (e = r,
            i = 0; i < o; ++i)
                n = t[i],
                a.visit(l)
        ...
        function l(t, i, c, f) {
            ...
            if (h * h / u < d)
                ...
                !0;
            if (!(t.length || d >= a)) {
                (t.data !== n || t.next) && (0 === s && (d += (s = Zo()) * s),
                0 === l && (d += (l = Zo()) * l),
                d < o && (d = Math.sqrt(o * d)));
                do {
                    t.data !== n && (h = r[t.data.index] * e / d,
                    n.vx += s * h,
                    n.vy += l * h)
                } while (t = t.next)
            }
        ...
        c.strength = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Wo(+t),
            f(),
            c) : i
        }
        ,
    ...
    t.forceRadial = function(t, n, e) {
        ...
        return "function" != typeof t && (t = Wo(+t)),
        null == n && (n = 0),
        null == e && (e = 0),
        ...
        u.strength = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : Wo(+t),
            c(),
            u) : a
        }
        ,
    ...
    t.forceSimulation = function(t) {
        ...
        n = {
            ...
            force: function(t, e) {
                return arguments.length > 1 ? (null == e ? u.remove(t) : u.set(t, d(e)),
                n) : u.get(t)
            },
            find: function(n, e, r) {
    ...
    t.forceX = function(t) {
        ...
        return "function" != typeof t && (t = Wo(null == t ? 0 : +t)),
        o.initialize = function(t) {
            n = t,
            a()
        }
    ...
    t.geoBounds = function(t) {
        ...
        e = Lu.length) {
            ...
            n = 1,
            o = [r = Lu[0]]; n < e; ++n)
                lc(r, (i = Lu[n])[0]) || lc(r, i[1]) ? (fc(r[0], i[1]) > fc(r[0], r[1]) && (r[1] = i[1]),
                fc(i[0], r[1]) > fc(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (a = -1 / 0,
            n = 0,
        ...
        return Lu = Uu = null,
        Tu === 1 / 0 || Eu === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Tu, Eu], [Cu, Pu]]
    }
    ,
    t.geoCentroid = function(t) {
        Ou = Yu = Bu = Fu = Iu = Hu = ju = Xu = Gu = Vu = $u = 0,
        cu(t, hc);
        var n = Gu
          , e = Vu
          , r = $u
        ...
        e = Fu,
        r = Iu),
        (i = n * n + e * e + r * r) < qa) ? [NaN, NaN] : [Ha(e, n) * Ya, tu(r / Qa(i)) * Ya]
    }
    ,
    t.geoCircle = function() {
        var t, n, e = Mc([0, 0]), r = Mc(90), i = Mc(6), o = {
            point: function(e, r) {
                t.push(e = n(e, r)),
                e[0] *= Ya,
                e[1] *= Ya
        ...
        return a.center = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Mc([+t[0], +t[1]]),
            a) : e
        }
        ,
        a.radius = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Mc(+t),
            a) : r
        }
        ,
        a.precision = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Mc(+t),
            a) : i
        }
        ,
        a
    ...
    t.geoAlbersUsa = function() {
        var t, n, e, r, i, o, a = Rs(), u = zs().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), c = zs().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), f = {
            point: function(t, n) {
                o = [t, n]
            }
        };
        ...
        s.translate = function(t) {
            ...
            r = u.translate([o - .307 * n, s + .201 * n]).clipExtent([[o - .425 * n + Ra, s + .12 * n + Ra], [o - .214 * n - Ra, s + .234 * n - Ra]]).stream(f),
            i = c.translate([o - .205 * n, s + .212 * n]).clipExtent([[o - .214 * n + Ra, s + .166 * n + Ra], [o - .115 * n - Ra, s + .234 * n - Ra]]).stream(f),
            l()
        }
        ,
    ...
    t.geoIdentity = function() {
        var t, n, e, r, i, o, a = 1, u = 0, c = 0, f = 1, s = 1, l = _f, h = null, d = _f;
        function p() {
            return r = i = null,
            o
        }
        return o = {
            ...
            postclip: function(r) {
                return arguments.length ? (d = r,
                h = t = n = e = null,
                p()) : d
            },
            clipExtent: function(r) {
                return arguments.length ? (d = null == r ? (h = t = n = e = null,
                _f) : Vc(h = +r[0][0], t = +r[0][1], n = +r[1][0], e = +r[1][1]),
                p()) : null == h ? null : [[h, t], [n, e]]
            },
            scale: function(t) {
                return arguments.length ? (l = Qs((a = +t) * f, a * s, u, c),
                p()) : a
            },
            translate: function(t) {
                return arguments.length ? (l = Qs(a * f, a * s, u = +t[0], c = +t[1]),
                p()) : [u, c]
            },
            reflectX: function(t) {
                return arguments.length ? (l = Qs(a * (f = t ? -1 : 1), a * s, u, c),
                p()) : f < 0
            },
            reflectY: function(t) {
                return arguments.length ? (l = Qs(a * f, a * (s = t ? -1 : 1), u, c),
                p()) : s < 0
            },
    ...
    t.geoOrthographic = function() {
        return Ts(Ks).scale(249.5).clipAngle(90 + Ra)
    }
    ,
    ...
    t.pack = function() {
        ...
        function i(i) {
            return i.x = n / 2,
            i.y = e / 2,
            t ? i.eachBefore(El(t)).eachAfter(Cl(r, .5)).eachBefore(Pl(1)) : i.eachBefore(El(Tl)).eachAfter(Cl(Sl, 1)).eachAfter(Cl(r, i.r / Math.min(n, e))).eachBefore(Pl(Math.min(n, e) / (2 * i.r))),
            i
        }
        return i.radius = function(n) {
            return arguments.length ? (t = null == (e = n) ? null : Al(e),
            i) : t;
            var e
        }
        ,
        ...
        i.padding = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : kl(+t),
            i) : r
        }
        ,
        i
    ...
    t.stratify = function() {
        ...
        function e(e) {
            ...
            for (i = 0; i < s; ++i)
                r = e[i],
                u = l[i] = new sl(r),
                null != (c = t(r, i, e)) && (c += "") && (h[f = ql + (u.id = c)] = f in h ? Ll : u);
            for (i = 0; i < s; ++i)
                if (u = l[i],
                null != (c = n(e[i], i, e)) && (c += "")) {
                    if (!(a = h[ql + c]))
        ...
        return e.id = function(n) {
            return arguments.length ? (t = Al(n),
            e) : t
        }
        ,
        e.parentId = function(t) {
            return arguments.length ? (n = Al(t),
            e) : n
        }
        ,
        e
    ...
    t.tree = function() {
            ...
            var c = function(t) {
                for (var n, e, r, i, o, a = new jl(t,0), u = [a]; n = u.pop(); )
                    if (r = n._.children)
                        ...
                        i = o - 1; i >= 0; --i)
                            u.push(e = n.children[i] = new jl(r[i],i)),
                            e.parent = n;
                return (a.parent = new jl(null,0)).children = [a],
                a
            }(i);
            if (c.eachAfter(o),
            c.parent.m = -c.z,
        ...
        function o(n) {
            ...
            n.parent.A = function(n, e, r) {
                if (e) {
                    for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = Fl(u),
                    o = Bl(o),
                    u && o; )
                        c = Bl(c),
                        (a = Fl(a)).a = n,
                        (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (Il(Hl(u, n, r), n, i),
                        f += i,
                        s += i),
                        l += u.m,
                        f += o.m,
    ...
    t.treemap = function() {
        ...
        s.paddingInner = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : kl(+t),
            s) : o
        }
        ,
        ...
        s.paddingTop = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : kl(+t),
            s) : a
        }
        ,
        s.paddingRight = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : kl(+t),
            s) : u
        }
        ,
        s.paddingBottom = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : kl(+t),
            s) : c
        }
        ,
        s.paddingLeft = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : kl(+t),
            s) : f
        }
        ,
        s
    ...
    t.scaleIdentity = function t(n) {
        ...
        r.domain = r.range = function(t) {
            return arguments.length ? (n = ch.call(t, dh),
            r) : n.slice()
        }
        ,
    ...
    t.scaleSqrt = function() {
        return Bh.apply(null, arguments).exponent(.5)
    }
    ,
    t.scaleQuantile = function t() {
        ...
        ,
        c.range = function(t) {
            return arguments.length ? (o = fh.call(t),
            u()) : o.slice()
        }
        ,
    ...
    t.scaleQuantize = function t() {
        ...
        ,
        c.range = function(t) {
            return arguments.length ? (o = (u = fh.call(t)).length - 1,
            f()) : u.slice()
        }
        ,
    ...
    t.scaleThreshold = function t() {
        ...
        return a.domain = function(t) {
            return arguments.length ? (e = fh.call(t),
            o = Math.min(e.length, r.length - 1),
            a) : e.slice()
        }
        ,
        a.range = function(t) {
            return arguments.length ? (r = fh.call(t),
            o = Math.min(e.length, r.length - 1),
            a) : r.slice()
        }
        ,
    ...
    t.interpolateSinebow = function(t) {
        ...
        Bg.r = 255 * (n = Math.sin(t)) * n,
        Bg.g = 255 * (n = Math.sin(t + Fg)) * n,
        Bg.b = 255 * (n = Math.sin(t + Ig)) * n,
        Bg + ""
    }
    ,
    ...
    t.arc = function() {
        var t = uy
          ...
          , u = null;
        function c() {
            var c, f, s, l = +t.apply(this, arguments), h = +n.apply(this, arguments), d = i.apply(this, arguments) - iy, p = o.apply(this, arguments) - iy, v = Wg(p - d), g = p > d;
            if (u || (u = c = ji()),
            h < l && (f = h,
            h = l,
            l = f),
            h > ey)
                if (v > oy - ey)
                    u.moveTo(h * Qg(d), h * ty(d)),
                    u.arc(0, 0, h, d, p, !g),
                    l > ey && (u.moveTo(l * Qg(p), l * ty(p)),
                    u.arc(0, 0, l, p, d, g));
                else {
                    var y, _, b = d, m = p, x = d, w = p, M = v, N = v, A = a.apply(this, arguments) / 2, S = A > ey && (r ? +r.apply(this, arguments) : ny(l * l + h * h)), k = Kg(Wg(h - l) / 2, +e.apply(this, arguments)), T = k, E = k;
                    if (S > ey) {
                        var C = ay(S / l * ty(A))
                          , P = ay(S / h * ty(A));
                        (M -= 2 * C) > ey ? (x += C *= g ? 1 : -1,
                    ...
                    var z = h * Qg(b)
                      ...
                      , D = l * ty(w);
                    if (k > ey) {
                        var L, U = h * Qg(m), O = h * ty(m), Y = l * Qg(x), B = l * ty(x);
                        if (v < ry && (L = function(t, n, e, r, i, o, a, u) {
                            var c = e - t
                              , f = r - n
                              , s = a - i
                              , l = u - o
                    ...
                    N > ey ? E > ey ? (y = hy(Y, B, z, R, h, E, g),
                    _ = hy(U, O, q, D, h, E, g),
                    u.moveTo(y.cx + y.x01, y.cy + y.y01),
                    E < k ? u.arc(y.cx, y.cy, E, Zg(y.y01, y.x01), Zg(_.y01, _.x01), !g) : (u.arc(y.cx, y.cy, E, Zg(y.y01, y.x01), Zg(y.y11, y.x11), !g),
                    u.arc(0, 0, h, Zg(y.cy + y.y11, y.cx + y.x11), Zg(_.cy + _.y11, _.cx + _.x11), !g),
                    u.arc(_.cx, _.cy, E, Zg(_.y11, _.x11), Zg(_.y01, _.x01), !g))) : (u.moveTo(z, R),
                    u.arc(0, 0, h, b, m, !g)) : u.moveTo(z, R),
                    l > ey && M > ey ? T > ey ? (y = hy(q, D, U, O, l, -T, g),
                    _ = hy(z, R, Y, B, l, -T, g),
                    u.lineTo(y.cx + y.x01, y.cy + y.y01),
                    T < k ? u.arc(y.cx, y.cy, T, Zg(y.y01, y.x01), Zg(_.y01, _.x01), !g) : (u.arc(y.cx, y.cy, T, Zg(y.y01, y.x01), Zg(y.y11, y.x11), !g),
                    u.arc(0, 0, l, Zg(y.cy + y.y11, y.cx + y.x11), Zg(_.cy + _.y11, _.cx + _.x11), g),
                    u.arc(_.cx, _.cy, T, Zg(_.y11, _.x11), Zg(_.y01, _.x01), !g))) : u.arc(0, 0, l, w, x, g) : u.lineTo(q, D)
                }
            else
                u.moveTo(0, 0);
            if (u.closePath(),
        ...
        c.endAngle = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : $g(+t),
            c) : o
        }
        ,
        c.padAngle = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : $g(+t),
            c) : a
        }
        ,
        c.context = function(t) {
    ...
    t.pie = function() {
        var t = my
          ...
          , o = $g(0);
        function a(a) {
            var u, c, f, s, l, h = a.length, d = 0, p = new Array(h), v = new Array(h), g = +r.apply(this, arguments), y = Math.min(oy, Math.max(-oy, i.apply(this, arguments) - g)), _ = Math.min(Math.abs(y) / h, o.apply(this, arguments)), b = _ * (y < 0 ? -1 : 1);
            for (u = 0; u < h; ++u)
    ...
    t.stack = function() {
        ...
        return i.keys = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : $g(Ty.call(n)),
            i) : t
        }
        ,
        i.value = function(t) {
        ...
        ,
        i.order = function(t) {
            return arguments.length ? (n = null == t ? P_ : "function" == typeof t ? t : $g(Ty.call(t)),
            i) : n
        }
        ,
        i.offset = function(t) {
            return arguments.length ? (e = null == t ? C_ : t,
            i) : e
        }
        ,
        i
    ...
    t.stackOrderInsideOut = function(t) {
        var n, e, r = t.length, i = t.map(L_), o = R_(t), a = 0, u = 0, c = [], f = [];
        for (n = 0; n < r; ++n)
            e = o[n],
            a < u ? (a += i[e],
            c.push(e)) : (u += i[e],
    ...
    t.active = function(t, n) {
        ...
        if (i)
            ...
            i)
                if ((e = i[r]).state > dr && e.name === n)
                    return new Er([[t]],fi,n,+r);
        return null
    }
    ,
    t.interrupt = Mr,
    t.voronoi = function() {
        ...
        ,
        r.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : U_(+n),
            r) : t
        }
        ,
        r.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : U_(+t),
            r) : n
        }
        ,
        r.extent = function(t) {
    ...
    ,
    t.zoom = function() {
        var n, e, r = kb, i = Tb, o = zb, a = Cb, u = Pb, c = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], s = 250, l = qe, h = [], d = I("start", "zoom", "end"), p = 500, v = 150, g = 0;
        function y(t) {
            t.property("__zoom", Eb).on("wheel.zoom", N).on("mousedown.zoom", A).on("dblclick.zoom", S).filter(u).on("touchstart.zoom", k).on("touchmove.zoom", T).on("touchend.zoom touchcancel.zoom", E).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)")
        }
        function _(t, n) {
        ...
        function S() {
            if (r.apply(this, arguments)) {
                ...
                Sb(),
                s > 0 ? zt(this).transition().duration(s).call(x, c, e) : zt(this).call(y.transform, c)
            }
        }
        function k() {
            if (r.apply(this, arguments)) {
                ...
                for (Ab(),
                i = 0; i < f; ++i)
                    a = [a = Yt(this, c, (o = c[i]).identifier), this.__zoom.invert(a), o.identifier],
                    u.touch0 ? u.touch1 || (u.touch1 = a) : (u.touch0 = a,
                    e = !0);
                if (n && (n = clearTimeout(n),
                !u.touch1))
                    return u.end(),
                    void ((a = zt(this).on("dblclick.zoom")) && a.apply(this, arguments));
        ...
        return y.transform = function(t, n) {
            ...
            t !== e ? x(t, n) : e.interrupt().each(function() {
        ...
        y.translateTo = function(t, n, e) {
            y.transform(t, function() {
                var t = i.apply(this, arguments)
                  , r = this.__zoom
                  , a = m(t);
                return o(Mb.translate(a[0], a[1]).scale(r.k).translate("function" == typeof n ? -n.apply(this, arguments) : -n, "function" == typeof e ? -e.apply(this, arguments) : -e), t, f)
            })
        }
        ,
        M.prototype = {
        ...
        y.wheelDelta = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : mb(+t),
            y) : a
        }
        ,
        y.filter = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : mb(!!t),
            y) : r
        }
        ,
        y.touchable = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : mb(!!t),
            y) : u
        }
        ,
        y.extent = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : mb([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            y) : i
        }
        ,
